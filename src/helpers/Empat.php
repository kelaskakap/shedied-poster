...
class Empat extends Numbers {
    ...
    static public function sources() {
        #asus
        $sources[10] = ['name' => 'Review - Asus: ZenBook', 'url' => 'https://www.asus.com/OfficialSiteAPI.asmx/GetModelResults?WebsiteId=1&ProductLevel2Id=155&FiltersCategory=35305&Filters=&Sort=3'];
