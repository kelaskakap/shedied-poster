...
function shedied_exec_bot($sources = [], $count = 1, $transient_name = '', $sweeper = false, $cat = 1) {
...
function bot_lokerkreasi_1() {
    ...
    shedied_exec_bot($sources, 20, 'tsnt_lokerkreasi_1', false, 5);
}
...
function bot_lokerkreasi_2() {
    ...
    shedied_exec_bot($sources, 20, 'tsnt_lokerkreasi_2', false, 5);
}
...
function bot_lokerkreasi_3() {
    ...
    shedied_exec_bot($sources, 20, 'tsnt_lokerkreasi_3', false, 5);
}
...
function bot_lokerkreasi_4() {
    ...
    shedied_exec_bot($sources, 20, 'tsnt_lokerkreasi_4', false, 5);
}
